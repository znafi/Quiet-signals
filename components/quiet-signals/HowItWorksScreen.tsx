...
const features = [
  ...
  },
  {
    ...
    body: 'Camera and voice reflections provide context only and will never diagnose or decide the result alone.',
      ...
      <div className="max-w-2xl mx-auto px-6 md:px-10 py-10 space-y-12">
        ...
        >
          ...
          <p className="text-sm text-muted-foreground leading-relaxed text-pretty max-w-lg">
            Quiet Signals uses scenario-based pattern recognition as its core evaluation engine. Optional face and voice inputs provide supportive context only.
          </p>
        </motion.div>
        ...
        >
          <p className="text-xs text-muted-foreground leading-relaxed text-center">
            Quiet Signals stores the name and email you provide with your score summary for real reflections. Demo profiles do not require contact details. Camera and voice signals are optional supportive signals only. This reflection is not a diagnosis.
          </p>
        </motion.div>
      </div>
    </main>
