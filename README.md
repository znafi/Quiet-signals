...
# Server-only, used by the final personalized summary route
GEMINI_API_KEY=
...
The final “What may be happening” summary is generated by Gemini from the saved score and supportive signal data. Gemini does not decide the result; scoring still comes from the local scoring and result mapping code.
