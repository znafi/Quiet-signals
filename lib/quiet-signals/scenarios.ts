    ...
    questions: [
      {
        ...
        choices: [
          { key: 'A', text: 'I feel ready and have enough energy to get going', description: 'I feel awake and steady. I can start work without needing caffeine, extra breaks, or mental buildup.', scores: { exhaustion: 0 } },
          { key: 'B', text: 'I feel a bit sluggish, but I push through once I get started', description: 'I feel groggy or low-energy at first and may rely on coffee, music, or routine to get moving.', scores: { exhaustion: 1 } },
      ...
      },
      {
        ...
        choices: [
          { key: 'A', text: "I feel engaged and ready to dig into what's ahead", description: 'I feel interested in the work and can picture myself getting things done productively.', scores: { mentalDistancing: 0 } },
          ...
          { key: 'C', text: 'I feel a sense of dread or indifference. It all feels pointless', description: 'I may procrastinate, stare at the list without starting, or think, "what is the point?"', scores: { mentalDistancing: 2 } },
        ],
      },
      {
        ...
        choices: [
          ...
          { key: 'B', text: 'I have to re-read things a few times before they sink in', description: 'I lose focus easily, forget what I just read, or need extra time to process information.', scores: { cognitiveImpairment: 1 } },
          { key: 'C', text: 'I keep losing my train of thought and struggle to get started', description: 'I may stare at the screen, forget what I was doing mid-task, or jump between tabs without progress.', scores: { cognitiveImpairment: 2 } },
        ],
      },
      {
        ...
        choices: [
          { key: 'A', text: 'I engage normally and am happy to connect', description: 'I feel comfortable socially and can respond warmly or naturally.', scores: { emotionalImpairment: 0 } },
          { key: 'B', text: "I respond politely but feel like I'm going through the motions", description: 'I force a smile or small talk, but internally feel detached or tired.', scores: { emotionalImpairment: 1 } },
          { key: 'C', text: 'I feel irritated by the interruption or have to hold back a sharp response', description: 'I feel tense, impatient, or emotionally reactive over a minor interaction.', scores: { emotionalImpairment: 2 } },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        choices: [
          { key: 'A', text: 'I feel engaged. I know I can handle this', description: 'I feel alert and capable of shifting into work mode without much stress.', scores: { exhaustion: 0 } },
          { key: 'B', text: "I feel a wave of tiredness but tell myself I'll manage", description: 'I may sigh, rub my eyes, grab another coffee, or mentally brace myself before starting.', scores: { exhaustion: 1 } },
          { key: 'C', text: "I feel immediately overwhelmed and physically heavy. I don't know where I'll find the energy", description: 'My chest may tighten, my body feels weighed down, or I feel like shutting down before I begin.', scores: { exhaustion: 2 } },
        ],
      },
      {
        dimension: 'mentalDistancing',
      ...
      },
      {
        ...
        choices: [
          { key: 'A', text: 'I can focus and work through it clearly', description: 'I can organize my thoughts and keep track of details without much difficulty.', scores: { cognitiveImpairment: 0 } },
          { key: 'B', text: 'I have to redo parts because I missed details or lost focus', description: 'I may forget instructions, skip steps, or reread emails multiple times.', scores: { cognitiveImpairment: 1 } },
          { key: 'C', text: "I make several errors and can't seem to hold the information in my head", description: 'I lose track of what I am doing, make careless mistakes, or feel mentally foggy throughout.', scores: { cognitiveImpairment: 2 } },
        ],
      },
      {
        dimension: 'emotionalImpairment',
        ...
        choices: [
          ...
          { key: 'B', text: 'I feel a flash of frustration but keep it together', description: 'I feel internally annoyed, tense, or interrupted, even if I respond politely.', scores: { emotionalImpairment: 1 } },
          { key: 'C', text: 'I snap or react more sharply than the situation calls for', description: 'I may sound short, defensive, or visibly irritated over a small request.', scores: { emotionalImpairment: 2 } },
        ],
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        choices: [
          { key: 'A', text: "I'm genuinely interested and contribute ideas", description: 'I feel mentally involved and motivated to participate in the discussion.', scores: { mentalDistancing: 0 } },
          { key: 'B', text: "I follow along but don't feel motivated to add much", description: 'I contribute only when necessary and mostly stay passive.', scores: { mentalDistancing: 1 } },
          { key: 'C', text: 'I feel disconnected. None of it feels meaningful enough to engage with', description: 'I feel emotionally detached and may mentally check out of the conversation entirely.', scores: { mentalDistancing: 2 } },
        ],
      },
      {
        dimension: 'cognitiveImpairment',
        ...
        choices: [
          { key: 'A', text: 'I recall it clearly and respond confidently', description: 'I can track the conversation and respond without difficulty.', scores: { cognitiveImpairment: 0 } },
          { key: 'B', text: 'I have to ask them to repeat it. I briefly zoned out', description: 'My attention drifts and I occasionally lose track of what is being discussed.', scores: { cognitiveImpairment: 1 } },
      ...
      },
      {
        ...
        choices: [
          { key: 'A', text: 'I engage with their perspective calmly and openly', description: 'I can handle disagreement without feeling personally threatened or upset.', scores: { emotionalImpairment: 0 } },
          ...
          { key: 'C', text: 'I feel a strong emotional reaction that feels out of proportion to what happened', description: 'I may feel embarrassed, angry, withdrawn, or emotionally overwhelmed by the interaction.', scores: { emotionalImpairment: 2 } },
        ],
      },
    ],
  },
